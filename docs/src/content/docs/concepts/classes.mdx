...
A class is declared using the `class` keyword. Like functions, classes are first-class in QangLang and can be passed as values and declared in the local scope.
